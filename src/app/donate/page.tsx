...
async function getDonationAccount(): Promise<DonationAccount | null> {
  try {
    const res = await fetch(`${NEXT_PUBLIC_BASE_URL}/api/donation-account`, {
      cache: "no-store",
    });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-8 max-w-md">
              Your donation helps us continue our work and serve the community
              effectively. Every contribution, no matter the amount, makes a
            ...
            {account ? (
              ...
              <div className="bg-[#f0faf4] border border-[#dcf3e7] rounded-xl p-6">
                <p className="text-gray-500 text-sm">
                  Bank account details will be updated soon. Please contact us
                  directly.
                </p>
              </div>
            )}
            ...
            <p className="text-gray-500 text-sm mt-10 leading-relaxed italic">
              May Allah bless you for your generosity, increase you in goodness,
              and accept it as sadaqah jāriyah. Ameen.
            </p>
          </div>
