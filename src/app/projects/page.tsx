    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-gray-500 text-sm mb-2">
          We are seeking your donations to complete our ongoing projects and
            ...
            {projects.map((project) => (
              ...
              >
                <div className="relative h-44 w-full">
                  ...
                  />
                  <span
                    className={`absolute top-3 right-3 text-xs px-2.5 py-1 rounded-full font-medium ${STATUS_COLORS[project.status] ?? "bg-gray-200 text-gray-700"}`}
                  >
                    {project.status}
                  </span>
                </div>
                <div className="p-4">
                  ...
                  {project.location && (
                    <p className="text-xs text-[#1B6B3A] font-medium mb-1">
                      {project.location}
                    </p>
                  )}
