  ...
  if (variant === "list") {
    return (
      <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="p-4">
          <h3 className="font-bold text-gray-900 text-base mb-2" style={{ fontFamily: "Outfit, sans-serif" }}>
            {project.title}
          </h3>
  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden">
      ...
      <div className="pt-3 pb-1">
        <h3 className="font-bold text-gray-900 text-sm mb-1.5" style={{ fontFamily: "Outfit, sans-serif" }}>
          {project.title}
        </h3>
