  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-8 max-w-7xl mx-auto">
      <div
        ...
        style={{
          background: "linear-gradient(135deg, #1B6B3A 0%, #2a8a4f 100%)",
        }}
      >
        {/* Decorative circles */}
        ...
        <div className="relative z-10 max-w-xl">
          ...
          <p className="text-white/80 text-sm leading-relaxed max-w-md">
            MCAN Ekiti State brings together Muslim graduates serving under the
            NYSC, building a community rooted in faith, service, and impact. We
            are committed to nurturing Islamic values while contributing
            meaningfully to society and community development across Ekiti
            State.
          </p>
        </div>
      </div>
